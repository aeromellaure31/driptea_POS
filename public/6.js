...
/* harmony import */ var _assets_noImage_jpg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../assets/noImage.jpg */ "./resources/assets/noImage.jpg");
/* harmony import */ var _assets_noImage_jpg__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_assets_noImage_jpg__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    return _ref = {
      noImage: _assets_noImage_jpg__WEBPACK_IMPORTED_MODULE_4___default.a,
      toSaveImage: null,
      toSaveImage2: null,
  ...
  methods: {
    ...
    getNumberDate: function getNumberDate(date, id) {
      return moment__WEBPACK_IMPORTED_MODULE_5___default()(date).format('MMDDYY') + id;
    },
    ...
    formSubmitProduct: function formSubmitProduct(e) {
      ...
      if (this.img !== '' && this.prodType !== '' && this.productName !== '' && this.lowPrice !== '' && this.highPrice !== '' && this.overPrice !== '' && this.onlinelowPrice !== '' && this.onlinehighPrice !== '' & this.onlineoverPrice !== '' && this.lowPrice !== '' && this.highPrice !== '' && this.overPrice !== '' && this.onlinelowPrice !== '' && this.onlinehighPrice !== '' && this.onlineoverPrice !== '' && this.img !== null && this.prodType !== null && this.productName !== null && this.lowPrice !== null && this.highPrice !== null && this.overPrice !== null && this.onlinelowPrice !== null && this.onlinehighPrice !== null & this.onlineoverPrice !== null && this.lowPrice > 0 && this.highPrice > 0 && this.overPrice > 0 && this.onlinelowPrice > 0 && this.onlinehighPrice > 0 && this.onlineoverPrice > 0 && this.errorMessage1 === null && this.errorMessage7 === null && this.errorMessage8 === null) {
        ...
        var formData = new FormData(); // formData.append('image', this.img)
    ...
    editProduct: function editProduct(item) {
      ...
      this.toSaveImage = item.image; // this.img = item.image
    ...
    updateProduct: function updateProduct(e) {
      ...
      if (this.img !== '' && this.prodType !== '' && this.productName !== '' && this.lowPrice !== '' && this.highPrice !== '' && this.overPrice !== '' && this.onlinelowPrice !== '' && this.onlinehighPrice !== '' & this.onlineoverPrice !== '' && this.lowPrice !== '' && this.highPrice !== '' && this.overPrice !== '' && this.onlinelowPrice !== '' && this.onlinehighPrice !== '' && this.onlineoverPrice !== '' && this.img !== null && this.prodType !== null && this.productName !== null && this.lowPrice !== null && this.highPrice !== null && this.overPrice !== null && this.onlinelowPrice !== null && this.onlinehighPrice !== null & this.onlineoverPrice !== null && this.lowPrice > 0 && this.highPrice > 0 && this.overPrice > 0 && this.onlinelowPrice > 0 && this.onlinehighPrice > 0 && this.onlineoverPrice > 0 && this.errorMessage1 === null && this.errorMessage7 === null && this.errorMessage8 === null) {
        ...
        formData.append('image', this.toSaveImage); // formData.append('image', this.img)
    ...
    formSubmit: function formSubmit(e) {
      if (this.image !== '' && this.productType !== '' && this.image !== null && this.productType !== null && this.image !== null && this.productType !== null && this.errorMessage7 === null && this.errorMessage8 === null) {
        ...
        var formData = new FormData(); // formData.append("image", this.image);
