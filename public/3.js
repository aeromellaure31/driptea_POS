...
/* harmony import */ var _Encryptor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Encryptor */ "./resources/js/modules/addingAdmin/Encryptor.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    Multiselect: vue_multiselect__WEBPACK_IMPORTED_MODULE_4___default.a // updateIng
  ...
  methods: {
    ...
    retrieveIngredients: function retrieveIngredients() {
      ...
      this.$axios.post(_services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].url + "retrieveIngredients", {}, _services_auth__WEBPACK_IMPORTED_MODULE_0__["default"].config).then(function (response) {
        ...
        _this4.ingredientsData.forEach(function (el, index) {
          _this4.options.push({
    ...
    onImgChange: function onImgChange(e) {
      ...
      if (this.img.size > 1024 * 1024) {
        ...
        this.$axios.post('https://api.mikaelagm.com/api/file/upload', data).then(function (res) {
          _this16.imgURL = URL.createObjectURL(e.target.files[0]);
    ...
    EnableDisableTextBox: function EnableDisableTextBox(item) {
      this.options.forEach(function (el) {
                              ...
                              _c("div", { staticClass: "row" }, [
                                _c("div", { staticClass: "col-md-6" }, [
                                  _c("input", {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.EnableDisableTextBox(
                                          item.ingredientsName
                                        )
                                      },
                                ...
                                _c(
                                  ...
                                  [
                                    _c("v-text-field", {
                                      attrs: {
                                        label: "Lowdose Quantity",
                                        outlined: "",
                                        dense: "",
                                        type: "number",
                                        id: item.ingredientsName + "1",
                                        readonly: ""
                                      },
                                      on: {
                                        keyup: function($event) {
                                      ...
                                      model: {
                                        value: item.lowDose,
                                        callback: function($$v) {
                                          _vm.$set(item, "lowDose", $$v)
                                        },
                                        expression: "item.lowDose"
                                      }
                                    })
                                  ],
                                  1
                                ...
                                _c(
                                  ...
                                  [
                                    _c("v-text-field", {
                                      attrs: {
                                        label: "Highdose Quantity",
                                        outlined: "",
                                        dense: "",
                                        type: "number",
                                        id: item.ingredientsName + "2",
                                        readonly: ""
                                      },
                                      on: {
                                        keyup: function($event) {
                                      ...
                                      model: {
                                        value: item.highDose,
                                        callback: function($$v) {
                                          _vm.$set(item, "highDose", $$v)
                                        },
                                        expression: "item.highDose"
                                      }
                                    })
                                  ],
                                  1
                                ...
                                _c(
                                  ...
                                  [
                                    _c("v-text-field", {
                                      attrs: {
                                        label: "Overdose Quantity",
                                        outlined: "",
                                        dense: "",
                                        type: "number",
                                        id: item.ingredientsName + "3",
                                        readonly: ""
                                      },
                                      on: {
                                        keyup: function($event) {
                                      ...
                                      model: {
                                        value: item.overDose,
                                        callback: function($$v) {
                                          _vm.$set(item, "overDose", $$v)
                                        },
                                        expression: "item.overDose"
                                      }
                                    })
                                  ],
                                  1
...
/***/ "./resources/js/modules/addingAdmin/Encryptor.js":
/*!*******************************************************!*\
  !*** ./resources/js/modules/addingAdmin/Encryptor.js ***!
  \*******************************************************/
/*! exports provided: default */
...
var iv = new Buffer.from('capstoneg6-2020b');
/* harmony default export */ __webpack_exports__["default"] = ({
